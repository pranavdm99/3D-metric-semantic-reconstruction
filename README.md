...
![COLMAP vs ARKit Trajectory Alignments](docs/assets/trajectory_plot.png)
...
![COLMAP Sparse Point Cloud](docs/assets/colmap_ply.png)
![SuGaR 3D Point Cloud Representation](docs/assets/3dgs_sugar_ply.gif)

---

### Phase 2: Semantic Segmentation & Scene Graph (`make segmentation`)

![YOLO + SAM2 2D Tracking Mask](docs/assets/tracking_mask.gif)
...
![3D Semantic Segmented Scene Viewer](docs/assets/segmented_scene_ply.gif)
...
![Semantic Object Relationship Graph](docs/assets/network_graph_map.png)
